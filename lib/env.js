	...
	.defaults(
        {
            ...
            ZITI_BROWZER_WHITELABEL: JSON.stringify({
                ...
                "branding": {
                    "browZerName":              "Hanzo ZT BrowZer",
                    "browZerSplashMessage":     "Stand by while Hanzo ZT BrowZer Bootstraps your private web app",
                    "browZerButtonIconSvgUrl":  `https://${nconf.get('ZITI_BROWZER_BOOTSTRAPPER_HOST')}/zt-browzer-logo.svg`,
