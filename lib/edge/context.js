 ...
 */
 module.exports = class ZitiContext extends EventEmitter {
  ...
  async initialize(options) {
    ...
    this._ztBrowzerEdgeClient = await this.createZitiBrowzerEdgeClient ({
      logger: this.logger,
  ...
  async createZitiBrowzerEdgeClient (options) {
    ...
    const { ZitiBrowzerEdgeClient } = await import('@hanzozt/zt-browzer-edge-client');
    ...
    let ztBrowzerEdgeClient = new ZitiBrowzerEdgeClient(Object.assign( {}, options))
  ...
  async apiSessionHeartbeat(self) {
    ...
    let idpAuthHealthEvent = {
      ztContext: self,  // let consumers know who emitted the event
