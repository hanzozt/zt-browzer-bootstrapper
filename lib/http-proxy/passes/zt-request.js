...
const { ZitiResponse } = require('./zt-response');
 ...
 * does not use Socket, and instead integrates with the zt-sdk-nodejs https_request_XXX
 * mechanisms.
 *
 * @api public
 */
...
class ZitiRequest extends EventEmitter {
    ...
    constructor(opts) {
        ...
        /**
         * The underlying Ziti HTTP Request (i.e. the um_http_req_t returned from Ziti_http_request() in the zt-sdk-NodeJS )
         */
        this.zt_http_request;
            ...
            try {
                ...
                self.zt.Ziti_http_request(
                    ...
                    (obj) => {
                        ...
                        // console.log('on_resp callback: req is: %o, statusCode: %o', this.zt_http_request, this.response.statusCode);
                    ...
                    (obj) => {
                        ...
                        // console.log('on_resp_body callback: req is: %o, len: %o', this.zt_http_request, obj.len);
    ...
    async start() {
        ...
        this.zt_http_request = await this.do_Ziti_http_request(
     ...
     */
        ...
        if (typeof this.zt_http_request !== 'undefined') {
            this.zt.Ziti_http_request_end( this.zt_http_request );
        }
    ...
    async do_Ziti_http_request_data(req, buffer) {
        ...
        return new Promise((resolve, reject) => {
            try {
                ...
                self.zt.Ziti_http_request_data(
                    req,
                    buffer,
